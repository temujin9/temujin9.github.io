...
> [40+ refs & full CV on LinkedIn](https://www.linkedin.com/in/temujin9/details/recommendations/)
...
_Kubernetes, Vault, Istio, Argo, Prometheus, Grafana, Golang, AWS, GCP, Azure, Claude, Terraform_
...
_Kubernetes, Argo, Helm, Prometheus, Python, TypeScript, Golang, AWS, Azure, Datadog, Terraform_
...
_Kubernetes, Helm, Prometheus, Grafana, ClusterAPI, Python, AWS, Puppet, Datadog_
...
_Kubernetes, Helm, Velero, Golang, Javascript, Python, AWS, GCP, Terraform, Docker, Cassandra_
...
_AWS, Docker, CloudFormation, Puppet, Java, Scala, Golang, Cassandra, Elasticsearch, Datadog_
...
_AWS, Rackspace, Chef, Ruby, Python, Javascript, Hadoop, HBase, Cassandra, Elasticsearch_
...
_Kubernetes, Flux, Helm, Golang, Javascript, Python, AWS, Azure, Terraform, Docker, MySQL_
